...
{
    public static final String ACTION_CHOOSE_DIRECTORY = "com.com.jdots.share.intent.action.CHOOSE_DIRECTORY";
    public static final String ACTION_CHOOSE_FILE = "com.com.jdots.share.intent.action.CHOOSE_FILE";
