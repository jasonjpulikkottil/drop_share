...
import com.jdots.share.util.OrganizeShareRunningTask;
        ...
        implements SnackbarSupport, Activity.OnPreloadArgumentWatcher, WorkerService.OnAttachListener
{
    ...
    public static final String ACTION_SEND = "com.jdots.share.intent.action.TBShare_SEND";
    public static final String ACTION_SEND_MULTIPLE = "com.jdots.share.intent.action.TBShare_SEND_MULTIPLE";
