...
import com.jdots.share.base.AppConfig;
import com.jdots.share.base.Keyword;
import com.jdots.share.db.AccessDatabase;
import com.jdots.share.fragment.FileListFragment;
import com.jdots.share.util.AppUtils;
import com.jdots.share.util.CommunicationBridge;
import com.jdots.share.util.CommunicationNotificationHelper;
import com.jdots.share.util.DynamicNotification;
import com.jdots.share.util.FileUtils;
import com.jdots.share.util.HotspotUtils;
import com.jdots.share.util.NetworkDeviceLoader;
import com.jdots.share.util.NetworkUtils;
import com.jdots.share.util.NotificationUtils;
import com.jdots.share.util.NsdDiscovery;
import com.jdots.share.util.TimeUtils;
...
import com.jdots.share.model.TextStreamObject;
import com.jdots.share.model.TransferGroup;
import com.jdots.share.model.TransferInstance;
import com.jdots.share.model.TransferObject;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.jdots.share.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.jdots.share.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.jdots.share.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.jdots.share.action.IP";
    public static final String ACTION_END_SESSION = "com.jdots.share.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.com.jdots.share.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.jdots.share.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.jdots.share.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.jdots.share.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.jdots.share.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.jdots.share.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.jdots.share.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.jdots.share.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.jdots.share.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.jdots.share.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.jdots.share.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.jdots.share.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.jdots.share.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.jdots.share.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.jdots.share.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.jdots.share.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.jdots.share.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.jdots.share.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.jdots.share.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.jdots.share.transaction.action.REQUEST_WEBSHARE_STATUS";
