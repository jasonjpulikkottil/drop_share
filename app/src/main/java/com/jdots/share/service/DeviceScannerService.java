...
import com.jdots.share.util.AddressedInterface;
import com.jdots.share.util.AppUtils;
import com.jdots.share.util.NetworkDeviceLoader;
import com.jdots.share.util.NetworkDeviceScanner;
...
{
    public static final String ACTION_SCAN_DEVICES = "com.jdots.share.intent.action.SCAN_DEVICES";
    public static final String ACTION_SCAN_STARTED = "com.jdots.share.intent.action.SCAN_STARTED";
    public static final String ACTION_DEVICE_SCAN_COMPLETED = "com.jdots.share.intent.action.DEVICE_SCAN_COMPLETED";

    public static final String EXTRA_SCAN_STATUS = "com.jdots.share.intent.extra.SCAN_STATUS";

    public static final String STATUS_OK = "com.jdots.share.intent.status.OK";
    public static final String STATUS_NO_NETWORK_INTERFACE = "com.jdots.share.intent.status.NO_NETWORK_INTERFACE";
    public static final String SCANNER_NOT_AVAILABLE = "com.jdots.share.intent.status.SCANNER_NOT_AVAILABLE";
